# -*- coding: utf-8 -*-
"""
Created on Wed Jul 23 14:16:53 2025
...
st.markdown("<head> NIGRIAN 2025 INCOME TAX CALCULATOR </head>", unsafe_allow_html=True)
st.markdown(
    "<center> <h1> NIGERIAN 2025 INCOME TAX CALCULATOR </h1> </center>", unsafe_allow_html=True
)
st.markdown(
